      ...
      <div class="container">
        ...
        <div id="top_sp" class="table_of_contents sp">
          ...
          <div class="article_item">
            ...
            体に不要な老廃物や余分な水分を、「腹膜」を通して血液から外に排出することで、血液をきれいにする治療方法です。<br>
          ...
          <div class="article_item">
            ...
            <p class="article_text">「腎臓」は体にとどまった老廃物を、尿を通して体外に排出する役割を持つ臓器です。
              その他にも、体の中の水分や電解質（ナトリウム、カリウム、リン他）などのバランスを整えたり、
          ...
          <div class="article_item">
            ...
            <p class="article_text">もし、腎臓の機能が10%を切ってしまうと、「腎不全」と診断され、「腎代替療法」という治療が必要になります。
              ...
              新たに健康な腎臓を植えることで、腎機能の改善を図る治療法です。
          ...
          <div class="article_item">
            ...
            <p class="article_text">「人工透析」は大きく２つに分けられます。血液透析と腹膜透析です。<br>
              「血液透析」は、ダイアライザーと呼ばれる人工的な機械を用いて、血液をきれいにする方法です。
              血液透析は通常、週3回通院し、一回につき4時間ほどの透析を受けます。
              機械が血液の中から不純物を除去します。
              透析を受けている間は、病院で座った状態または寝た状態で過ごします。<br>
              「腹膜透析」とは、お腹の中に透析液を流し込み、一定時間貯めておくことで、
              体に不要な老廃物や余分な水分を「腹膜」を通して外に排出することで、血液をきれいにする治療方法です。
              腹膜透析には、CAPD（持続携帯式腹膜透析）とAPD（自動腹膜透析）、両方を合わせたCCPDなどの方法があります。
            </p>
          </div>
          ...
          <div class="article_item">
            ...
            <p class="article_text">
            「CAPD」の場合、朝昼晩、寝る前と毎日４回程度透析を行います。
            透析液を点滴の要領で体内に注入し一定時間貯めることにより、血液の中の不純物を排出していきます。
            透析をしている間は、自由に過ごすことが可能です。透析液が入ったバッグの交換は自ら行います。
            </p>
          ...
          <div class="article_item">
            ...
            <p class="article_text">「APD」の場合、毎日1回、一回につき7時間ほどの透析を行います。
              機械が自動でバッグ交換を行いますので、交換の手間はありません。
          ...
          <div class="article_item">
            ...
            <p class="article_text">腹膜透析は医療機関に頻繁に通わず、自宅で行える治療です。
            ...
            <p class="article_text">患者さんのライフスタイルにあわせて、治療を方法が選べます。
              ...
              自宅で自分の予定に合わせて透析を行うことが可能です。<br>
              自らが行う方式ですので、
              旅行先や出張先でも行うことが可能です。
              医療機関の診察は月に一回程度です。
              高齢などで外来に行けない方は医師に自宅に来ていただければ、医療機関に行くことはありません。
            </p>
          </div>
          ...
          <div class="article_item">
            ...
            <p class="article_text">
            血液透析では、血液を血管から取り出してダイアライザーに流し込むために、シャントと呼ばれる太い血管を作るための手術が必要です。
            </p>
          </div>
          ...
          <div class="article_item">
            <h3>
              <span id="kiso11" class="article_item_title pc">PDファースト</span>
          ...
          <div class="article_item">
            <h3>
              <span id="kiso12" class="article_item_title pc">PDラスト</span>
              <p id="kiso12_sp" class="article_item_title sp">PDラスト</p>
            </h3>
            <p class="article_text">
            「PDラスト」とは、人生の終末期に「腹膜透析（PD）で終わる」という選択をすることです。
            透析を長く続けていると、心血管系の合併症（心筋梗塞、弁膜症、心不全や脳梗塞など）や血管の劣化などで血液透析を続けることが難しくなる、
            加齢に伴うADLの低下で通院治療が難しくなる、など血液透析を続けることが困難になる可能性があります。
            その場合に、腹膜透析に移行する選択肢があります。腹膜透析は、血液透析に比べて心血管系への負担が少なく、
            また通院をせずに自宅で日常生活をしながら治療を続けることが可能です。
            人生の最期を自宅で迎えるために、血液透析から腹膜透析に移行することが可能です。
            </p>
          </div>

          <div class="article_item">
            <h3>
              <span id="kiso13" class="article_item_title pc">ハイブリット（血液・腹膜併用療法）</span>
              <p id="kiso13_sp" class="article_item_title sp">ハイブリット（血液・腹膜併用療法）</p>
            </h3>
            <p class="article_text">
              腹膜透析と血液透析を併用する「ハイブリット」と呼ばれる方法があります。
              腹膜透析が長期になると腹膜機能が低下して透析不足になる可能性があります。
              そうすると、体内の老廃物や過剰な水分が十分に排出できなくなります。
          ...
          <div class="article_item">
            <h3>
              <span id="kiso14" class="article_item_title pc">透析の治療場所は外来・入院97％、在宅3％</span>

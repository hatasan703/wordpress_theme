    ...
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
      <div class="container">
        <div class="article_wrap2">
          ...
          <?php the_content(); ?>
        <!-- <br><br><br><br>
        <div id="kiso_table_of_contents" class="table_of_contents">
        ...
        <ul class="table_of_contents_lists">
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso1" class="article_item_title sp">腹膜透析とは</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso2" class="article_item_title sp">腎臓の働き、腎機能が低下すると…</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso3" class="article_item_title sp">腎代替療法とは</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso4" class="article_item_title sp">腎臓移植の課題</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso5" class="article_item_title sp">血液透析と腹膜透析</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso6" class="article_item_title sp">CAPD（持続携帯式腹膜透析）</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso7" class="article_item_title sp">APD（自動腹膜透析）</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso8" class="article_item_title sp">腹膜透析と生活</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso9" class="article_item_title sp">腹膜透析の手術</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso10" class="article_item_title sp">血液透析の手術</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso11" class="article_item_title sp">透析と新型コロナウイルス</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso12" class="article_item_title sp">透析医療機関は緊急事態が続いている</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso13" class="article_item_title sp">PDファースト</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso14" class="article_item_title sp">PDラスト</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso15" class="article_item_title sp">ハイブリット（血液・腹膜併用療法）</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso16" class="article_item_title sp">透析患者数は約34万人</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso17" class="article_item_title sp">新規導入患者数と死亡数</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso18" class="article_item_title sp">透析の治療場所は外来・入院97％、在宅3％</p>
            </h3>
          ...
          <div class="article_item">
            <h3>
              ...
              <p id="kiso19" class="article_item_title sp">夜間の透析患者</p>
            </h3>

      ...
      <div class="container">
        ...
        <div class="article_wrap1">
          ...
          <div class="article_item">
            ...
            <p class="article_text">血液透析は、週の半分近く（基本は週３回）を透析治療に費やすことになります。 
            これまで続けてきた仕事も、家族友人との遊びも、日々の食事も多くの制限があり、これまでの普通な生活が一変します。
             また、透析をする前と後の体調の不安定さが伴いますので、精神的にも大きな負担があることでしょう。 
             この透析中心の生活を、ずっと続けていくと考えると、途方に暮れてしまう方もいるでしょう。</p>
          </div>
          <div class="article_item">
            <h3>
            ...
            もし、これからも働きたい、会社を辞めたくない、自分の体の調子を見ながらできる限りのことをやっていきたい、 ライフスタイルを変えたくないと考えるのなら選択肢の中に、おうちでできる「腹膜透析」を入れてみてください。</p>
          </div>
          <div class="article_item">
            <h3>
          ...
          <div class="article_item">
            ...
            <p class="article_image"><img class="alignnone  wp-image-181" src="http://dev.local/wp-content/uploads/2020/08/43-1.png" alt="表" width="660" height="505" /></p>
          </div>
          <div class="article_item">
            <h3>
            ...
            血液透析は、腕にシャントと呼ばれる太い血管を作る手術を行います。 
            一方、腹膜透析は透析液をお腹にいれるために、カテーテルと呼ばれるチューブをお腹に入れる手術を行います。<br />
            血液透析はダイアライザーと呼ばれる機器で余分な水分や老廃物を除去するため、治療効果としては腹膜透析より高いとされています。
            一方で、腹膜透析は自らの腹膜を使って余分な水分や老廃物を除去するため、血液透析に比べてゆっくりと行われます。
            そのため、腹膜透析は血液透析に比べて体への影響が少なく、血管や心臓への影響が少なく、
            また、透析治療を開始する際、腹膜透析から始める人は残された腎臓の機能（残腎機能）を保護する効果も高いとされています。
            このような人は、長く自ら尿を排出することが可能です。<br>
            血液透析は、医療機関で医療スタッフに治療自体はお任せできます。
            一方で、腹膜透析は自分や家族が透析液を交換するなど、自ら行う治療法ですので、全てお任せというわけにはいきません。
            透析バッグ交換の仕方や衛生管理の仕方を教えてもらって、自らが行う必要があります。しかし、ご高齢でご自分で行えない場合は、
            訪問看護師が伺いお手伝いをする（Assisted PD）方法も選ぶことができます。<br>

            血液透析は、医療機関で医師や看護師の管理下で行われるため、何かトラブルがあってもその場で対応いただけるので安心です。 
            一方、腹膜透析は自宅で行うので、「何かあったらどうしよう？」と不安に感じるかもしれません。<br>
            政府の推進により、我が国では「在宅医療」が年々充実してきており、医師や訪問看護師が定期的に自宅に来てくれるようになりました。 
            緊急時にもいち早く駆けつけてくれる仕組みもあります。
            また、最近ではインターネットの発展により「遠隔モニタリング（離れて患者の状態を見守る）」が可能になっており、
            トラブル時にも素早く対応できるようになっています。
            この遠隔モニタリングは、腹膜透析で起きやすいとされる感染症に対しても効果があり、
          ...
          <div class="article_item">
            ...
            <div class="article_text">
              ...
              <p class="article_image"><img class="alignnone  wp-image-182" src="http://dev.local/wp-content/uploads/2020/08/44-1.png" alt="表2" width="683" height="287" /></p>
              <p>生活面では、仕事、食事制限といずれも、腹膜透析は血液透析よりも制限が少ないとされています。 腹膜透析は血液透析に比べて自宅で好きな時間でき、体への負担が少ないため、QOL（生活の質）が高いとされています。<br />
              血液透析と腹膜透析を組み合わせた併用療法を選ぶ方も増えています。これはハイブリットと呼ばれて、 「治療効果の高い」血液透析のメリットと、「QOLの高い」腹膜透析のメリットを組み合わせた方法です。<br />
              <br />
              このように、それぞれの療法について、治療面、生活面のメリットデメリットを踏まえて選択していただくと良いのですが、 まずはご自身の年齢や何をしたいかを基準に考えて選択されると良いと思います。血液透析から腹膜透析へ移行する、 腹膜透析から血液透析へ移行する、どちらも選択が可能です。主治医とよく相談して、最善の治療方法を選んでください。</p>
            </div>
          </div>
          <div class="article_item">
            <h3>
            ...
            いま、政府が進めている「働き方改革」は、残業の上限規制、有給休暇の取得、同一労働同一賃金など、 様々ありますが、
            これまでなかなか進まなかった、働きたくても働けなかった方が「社会復帰をしやすい社会」を作ろうとする改革のことです。<br>
             現在、新型コロナウイルスの感染拡大により、働く環境も大きく変わろうとしています。出勤を極力せずに、 
             自宅でリモートワークを勧める会社がどんどん増えています。 このような状況下で、「透析をしながら働くこと」に対して、職場の理解も進んでいくことでしょう。 おうちで透析は、働きながら透析治療を行う上で最適です。<br />
            また、腹膜透析は出張も旅行も可能です。 出張先、旅行先のホテルに透析液を届けてもらうことも可能です。</p>
          </div>
            <div class="article_item">
            <h3>
          ...
          <div class="article_item">
            ...
            <p class="article_text">長く血液透析を続け、年齢を重ねていくと、いずれ体力が落ち、歩くことも困難になっていきます。 そうなると、血液透析のために医療機関に通うのが難しくなっていきます。また、送迎してくれる家族も同じように高齢になっていきます。 そうなると、入院での透析治療を行う必要が出てきます。「入院での透析」を選ぶか、「在宅での透析」を選ぶかは、ご自身の選択によります。<br />
            ...
            生きることは死ぬことです。いつか来る最期を決めるのはご自身であり、家族なのです。</p>
          </div>
          <div class="article_item">
            <h3>
            ...
            <br />
            健康な時は死ぬことや、入院、自分が病気になることなど考えないものです。 キャリアも、生き方も、楽しみも諦めない、そんな透析患者さんが増えることを切に願うとともに、 そのことが実現できる医療体制の構築をお手伝いできればと思います。</p>
          </div> -->
          <!-- 固定-->

      ...
      <div class="container">
        <div class="article_wrap2">
          ...
          <div class="article_item">
            ...
            血液透析はダイアライザーと呼ばれる機器で血液を直接きれいにするため、治療効果としては腹膜透析より高いとされています。 一方で、腹膜透析は自らの腹膜を使って血液をきれいにするため、血液透析に比べてゆっくりと行われます。 そのため、腹膜透析は血液透析に比べて体への影響が少なく、血管や心臓への影響が少なく、 また、残された腎臓の機能（残腎機能）を保護する効果も高いとされています。 腹膜透析は、長く自ら尿を排出することが可能です。<br />
            血液透析は、医療機関で医療スタッフに治療自体はお任せできます。 一方で、腹膜透析は自分や家族が透析液を交換するなど、自ら行う治療法ですので、全てお任せというわけにはいきません。 効果の仕方や衛生管理の仕方を教えてもらって、自らが行う必要があります。<br />
            血液透析は、医療機関で医師や看護師の管理下で行われるため、何かトラブルがあってもその場で対応いただけるので安心です。 一方、腹膜透析は自宅で行うので、「何かあったらどうしよう？」と不安に感じるかもしれません。 政府の推進により、我が国では「在宅医療」が年々充実してきており、医師や訪問看護師が定期的に自宅に来てくれるようになりました。 また、最近ではインターネットの発展により「遠隔監視（離れて患者の状態を見守る）」が可能になっており、 トラブル時にも素早く対応できるようになっています。 この遠隔監視は、腹膜透析で起きやすいとされる感染症に対しても効果があり、 医師、看護師、介護士などが情報連携を行い、フォローする仕組みができています。<br />
            かつて腹膜透析で不安とされていた問題が、年々解消されているのです。</p>
          </div>
          <div class="article_item">
            <h3>
            ...
            <div class="article_text">
              ...
              <p>生活面では、仕事、食事制限、旅行、運動、入浴といずれも、腹膜透析は血液透析よりも制限が少ないとされています。 腹膜透析は血液透析に比べて自宅で好きな時間でき、体への負担が少ないため、QOL（生活の質）が高いとされています。<br />
          ...
          <div class="article_item">
            ...
            また、腹膜透析は出張も旅行も可能です。 事前に関係者に連絡するなど、根回しは必要ですが、出張先、旅行先のホテルに透析液を届けてもらうことも可能です。</p>
          </div>
            <div class="article_item">
            <h3>

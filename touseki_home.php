...
それは知識が不足しているから起きる不安です。透析について学び正しい知識を得ることが大切です。</p>
...
<h3 class="pc"><span id="home1" class="article_item_title">透析患者の数</span></h3>
<h3 class="sp"><p id="home1" class="article_item_title">透析患者の数</p></h3>
...
<div class="article_item">
<h3 class="pc"><span id="home2" class="article_item_title">なぜ、透析が必要なの？</span></h3>
<h3 class="sp"><p id="home2" class="article_item_title">なぜ、透析が必要なの？</p></h3>
...
人工透析を行うことで血液をきれいにして体を正常な状態に保つのです。</p>

</div>
<div class="article_item">
<h3 class="pc"><span id="home3" class="article_item_title">どんな治療方法があるの</span></h3>
<h3 class="sp"><p id="home3" class="article_item_title">どんな治療方法があるの</p></h3>
<p class="article_text">医師から突然、「透析が必要」と告げられたら、誰もがどう受け止めたら良いのか途方に暮れることでしょう。
...
日中に行うことも可能です。透析をしている間は自宅で自由に過ごすことが可能です。</p>
<p class="article_image"><img class="alignnone wp-image-172 image_34" src="http://dev.local/wp-content/uploads/2020/08/34-1.png" alt="CAPD/APD" width="607" height="382" /></p>

</div>
<div class="article_item">
<h3 class="pc"><span id="home6" class="article_item_title">おうちでできる透析がある</span></h3>
<h3 class="sp"><p id="home6" class="article_item_title">おうちでできる透析がある</p></h3>
<p class="article_text">腹膜透析は自宅でできる、つまり「おうちでできる透析治療」です。
しかしながら、現在の透析を行う場所は、医療機関等の施設が「97％」、在宅が「3％」です。
この数字は先進諸国の中では最も低い部類に入るとされています。わが国は、様々な理由から、
在宅での透析がほとんど進んでいないのが現状です。
<span class="back_color">「おうちでできる透析」この選択肢があることを忘れないでください。</span></p>

</div>
<div class="article_item">
<h3 class="pc"><span id="home7" class="article_item_title">新型コロナウイルス感染症と透析治療</span></h3>
<h3 class="sp"><p id="home7" class="article_item_title">新型コロナウイルス感染症と透析治療</p></h3>
<p class="article_text">「現在、「新型コロナウイルス感染症」が世界的に感染が拡大しています。
...
新型コロナウイルスに対して、最も注意が必要な疾患とされています。もちろん医療現場では密の対策をしっかりととっていますが、そうはいっても不安を感じる方は多いでしょう。
新型コロナウイルスは、我々が当たり前と思っていることを、当たり前ではなくします。
家族と一緒にいられる時間や、当たり前と思って過ごしている何気ない日常は、ある日突然に当たり前ではなくなるのです。
このようなコロナ禍においては、密を避け安全安心な治療を希望する方も増えています。
自宅でできる腹膜透析や、通院回数が減らせる併用療法がその受け皿になっています。</p>

</div>
<div class="article_item">
<h3 class="pc"><span id="home8" class="article_item_title">ライフスタイルに合わせて治療方法を選べる時代</span></h3>
<h3 class="sp"><p id="home8" class="article_item_title">ライフスタイルに合わせて治療方法を選べる時代</p></h3>
<p class="article_text">ライフスタイルに合わせてご自身で治療方法を選択する時代がやってきました。
...
一筋の希望の光が差し込むのではないでしょうか。
おうちで透析を是非お考えください。
腹膜透析はライフスタイルやキャリアデザインを大幅に変えることなく生活の質（Q O L）を保ちながら生きていくために開発された仕組みです。</p>

</div>
<div class="article_item">
<h3 class="pc"><span id="home9" class="article_item_title">仕事をしながら治療ができる</span></h3>
<h3 class="sp"><p id="home9" class="article_item_title">仕事をしながら治療ができる</p></h3>
<p class="article_text">腹膜透析は、自らが透析治療を行うため、仕事もできます。出張もできます。
家族旅行もできます。透析が必要になったからといって、人生を諦めなくても良いのです。
きちんとした情報を得ることにより、あなたの今の生活をできる限り変えないで過ごすことが可能なのです。
最近では「ながら就業」も当たり前となってきました。癌をはじめとした長期に闘わなくてはならない病気でも、
自身の納得のいくライフスタイルに合わせたものを選択することにより、仕事を続けることができるのです。
実際、腹膜透析を選択したことで、今の働き方とほぼ変わることなく、仕事を続けている方がいらっしゃいます。</p>

</div>
<div class="article_item">
<h3 class="pc"><span id="home10" class="article_item_title">治療法を選択する勇気</span></h3>
<h3 class="sp"><p id="home10" class="article_item_title">治療法を選択する勇気</p></h3>
<p class="article_text">医師から透析の宣告を受けた際、「自ら治療法を選択する勇気」を持って頂きたいのです。
勇気を持つためには、正しい情報を多く集めることや、それを冷静に判断できる状況、
そして家族の理解と手助けが必要になります。
未来への希望を捨てないためにも、治療法は患者が自信が選ぶべきなのです。
医療は出会いです。納得のいかないことや、不安でいっぱいのまま医師や周りの意見を受け入れるのではなく、
自分が病気になった時にやるべきことは、まず何より情報を集めることです。
将来、どのように過ごしていきたいかを見つめ直すことも大切です。
...
透析治療が必要になったからといって、キャリアを、人生を、あきらめなくても良い時代が来ているのです。</p>
